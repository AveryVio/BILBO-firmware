...
#define TUNE_FALSE_DIFF_INFTY 2
#define TUNE_FALSE_DIFF_OOR 3
#define TUNE_FALSE_DIFF_OOR_ABSOLUTE 4
#define TUNE_FALSE_DIFF_OOR_OUT_OF_OCTIVES 5
#define TUNE_FALSE_DIFF_ERR 6

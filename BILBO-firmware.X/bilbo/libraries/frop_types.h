...
typedef union {
    uint8_t data[6]; // real length is 5, last one is newline for communication
...
typedef union {
    uint8_t data[5]; // real length is 4, last one is newline for communication
...
typedef union {
    uint8_t data[17]; // real length is 16, last one is newline for communication
...
typedef union {
    uint8_t data[10]; // real length is 9, last one is newline for communication
...
typedef union {
    uint8_t data[19]; // real length is 18, last one is newline for communication
